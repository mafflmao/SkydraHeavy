...
namespace LibSkydra.IO
{
	...
	public class StreamHelper : BinaryReader
	{
		...
		public void Seek(ulong offset, SeekOrigin origin = SeekOrigin.Begin) => BaseStream.Seek((long)offset, origin);
		...
		public string ReadString(uint offset) => ReadString((ulong)offset);
